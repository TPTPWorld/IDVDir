...
public interface TPTPListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link TPTPParser#null}.
	 * @param ctx the parse tree
	 */
	void enterNull(TPTPParser.NullContext ctx);
	/**
	 * Exit a parse tree produced by {@link TPTPParser#null}.
	 * @param ctx the parse tree
	 */
	void exitNull(TPTPParser.NullContext ctx);
}